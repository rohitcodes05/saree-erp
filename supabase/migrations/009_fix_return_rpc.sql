-- ============================================================
-- SAREE ERP – FIX RETURNS RPC
-- Migration: 009_fix_return_rpc.sql
-- ============================================================

-- The previous version of process_return failed because the 
-- return_items table requires a 'unit_price' column which is NOT NULL.
-- This updated RPC safely includes unit_price during insertion.
...
BEGIN
  ...
  LOOP
    -- A. Insert into return_items (NOW WITH UNIT_PRICE)
    ...
    IF p_restocked THEN
      -- Update inventory quantity cleanly
